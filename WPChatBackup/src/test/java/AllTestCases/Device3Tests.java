...
//method recreate to start appium server
		...
		{
			Base.StartAppiumServer(Resources.fetchResource("Device3PortNo"));
		    driver= Base.InitDriver(Resources.fetchResource("Device3PortNo"), Resources.fetchResource("Device3UdId"));
...
//Original whatsapp starts from here
		...
		@Test(priority = 1)
		public static void device3_FM_Test() throws Exception
		{
		...
		@Test(priority = 2)
		public static void device3_GB_Test() throws Exception
		{
		...
		@Test(priority = 3)
		public static void device3_WB_Test() throws Exception
		{
		...
		@Test(priority = 4)
		public static void device3_AERO_I_Test() throws Exception
		{
		...
		@Test(priority = 5)
		public static void device3_AERO_II_Test() throws Exception
		{
		...
		@Test(priority = 6)
		public static void device3_WA_Test() throws Exception
		{
		...
		@Test(priority = 7)
		public static void device3_YO_Test() throws Exception
		{
	...
	//Dual whatsapp starts from here
		...
		@Test(priority = 8)
		public static void device3_Dual_FM_Test() throws Exception
		{
		...
		@Test(priority = 9)
		public static void device3_Dual_GB_Test() throws Exception
		{
		...
		@Test(priority = 10)
		public static void device3_Dual_WB_Test() throws Exception
		{
		...
		@Test(priority = 11)
		public static void device3_Dual_AERO_I_Test() throws Exception
		{
		...
		@Test(priority = 12)
		public static void device3_Dual_AERO_II_Test() throws Exception
		{
		//	 AppiumDriver driver= Base.InitDriver(Resources.fetchResource("device3PortNo"), Resources.fetchResource("device3UdId"));
			Actions.startHomeActivity(driver, Resources.fetchResource("AEROIIPackage"), Resources.fetchResource("AEROIIActivity"), "Dual");
			 MainLogic.MainMethod(driver);
		}
		
		@Test(priority = 13)
		public static void device3_Dual_WA_Test() throws Exception
		{
		...
		@Test(priority = 14)
		public static void device3_Dual_YO_Test() throws Exception
		{
...
//Work whatsapp starts from here
		...
		@Test(priority = 15)
		public static void device3_Work_FM_Test() throws Exception
		{
		...
		@Test(priority = 16)
		public static void device3_Work_GB_Test() throws Exception
		{
		...
		@Test(priority = 17)
		public static void device3_Work_WB_Test() throws Exception
		{
		...
		@Test(priority = 18)
		public static void device3_Work_AERO_I_Test() throws Exception
		{
		...
		@Test(priority = 19)
		public static void device3_Work_AERO_II_Test() throws Exception
		{
		...
		@Test(priority = 20)
		public static void device3_Work_WA_Test() throws Exception
		{
		...
		@Test(priority = 21)
		public static void device3_Work_YO_Test() throws Exception
		{
