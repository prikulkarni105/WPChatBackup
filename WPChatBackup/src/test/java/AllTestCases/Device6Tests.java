...
//method recreate to start appium server
		...
		{
			Base.StartAppiumServer(Resources.fetchResource("Device6PortNo"));
		    driver= Base.InitDriver(Resources.fetchResource("Devic65PortNo"), Resources.fetchResource("Device6UdId"));
...
//Original whatsapp starts from here
		...
		@Test(priority = 1)
		public static void device6_FM_Test() throws Exception
		{
		...
		@Test(priority = 2)
		public static void device6_GB_Test() throws Exception
		{
		...
		@Test(priority = 3)
		public static void device6_WB_Test() throws Exception
		{
		...
		@Test(priority = 4)
		public static void device6_AERO_I_Test() throws Exception
		{
		...
		@Test(priority = 5)
		public static void device6_AERO_II_Test() throws Exception
		{
		//	 AppiumDriver driver= Base.InitDriver(Resources.fetchResource("device6PortNo"), Resources.fetchResource("device6UdId"));
			Actions.startHomeActivity(driver, Resources.fetchResource("AEROIIPackage"), Resources.fetchResource("AEROIIActivity"), "Original");
			 MainLogic.MainMethod(driver);
		}
		
		@Test(priority = 6)
		public static void device6_WA_Test() throws Exception
		{
		...
		@Test(priority = 7)
		public static void device6_YO_Test() throws Exception
		{
...
//Dual whatsapp starts from here
		...
		@Test(priority = 8)
		public static void device6_Dual_FM_Test() throws Exception
		{
		...
		@Test(priority = 9)
		public static void device6_Dual_GB_Test() throws Exception
		{
		...
		@Test(priority = 10)
		public static void device6_Dual_WB_Test() throws Exception
		{
		...
		@Test(priority = 11)
		public static void device6_Dual_AERO_I_Test() throws Exception
		{
		...
		@Test(priority = 12)
		public static void device6_Dual_AERO_II_Test() throws Exception
		{
		//	 AppiumDriver driver= Base.InitDriver(Resources.fetchResource("device6PortNo"), Resources.fetchResource("device6UdId"));
		...
		@Test(priority = 13)
		public static void device6_Dual_WA_Test() throws Exception
		{
		...
		@Test(priority = 14)
		public static void device6_Dual_YO_Test() throws Exception
		{
...
//Work whatsapp starts from here
		...
		@Test(priority = 15)
		public static void device6_Work_FM_Test() throws Exception
		{
		...
		@Test(priority = 16)
		public static void device6_Work_GB_Test() throws Exception
		{
		...
		@Test(priority = 17)
		public static void device6_Work_WB_Test() throws Exception
		{
		...
		@Test(priority = 18)
		public static void device6_Work_AERO_I_Test() throws Exception
		{
		...
		@Test(priority = 19)
		public static void device6_Work_AERO_II_Test() throws Exception
		{
		...
		@Test(priority = 20)
		public static void device6_Work_WA_Test() throws Exception
		{
		...
		@Test(priority = 21)
		public static void device6_Work_YO_Test() throws Exception
		{
