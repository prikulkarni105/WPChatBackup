...
//method recreate to start appium server
		...
		{
			Base.StartAppiumServer(Resources.fetchResource("Device5PortNo"));
		    driver= Base.InitDriver(Resources.fetchResource("Device5PortNo"), Resources.fetchResource("Device5UdId"));
...
//Original whatsapp starts from here
		...
		@Test(priority = 1)
		public static void device5_FM_Test() throws Exception
		{
		...
		@Test(priority = 2)
		public static void device5_GB_Test() throws Exception
		{
		...
		@Test(priority = 3)
		public static void device5_WB_Test() throws Exception
		{
		...
		@Test(priority = 4)
		public static void device5_AERO_I_Test() throws Exception
		{
		...
		@Test(priority = 5)
		public static void device5_AERO_II_Test() throws Exception
		{
		//	 AppiumDriver driver= Base.InitDriver(Resources.fetchResource("device5PortNo"), Resources.fetchResource("device5UdId"));
			Actions.startHomeActivity(driver, Resources.fetchResource("AEROIIPackage"), Resources.fetchResource("AEROIIActivity"), "Original");
			 MainLogic.MainMethod(driver);
		}
		
		@Test(priority = 6)
		public static void device5_WA_Test() throws Exception
		{
		...
		@Test(priority = 7)
		public static void device5_YO_Test() throws Exception
		{
...
//Dual whatsapp starts from here
		...
		@Test(priority = 8)
		public static void device5_Dual_FM_Test() throws Exception
		{
		...
		@Test(priority = 9)
		public static void device5_Dual_GB_Test() throws Exception
		{
		...
		@Test(priority = 10)
		public static void device5_Dual_WB_Test() throws Exception
		{
		...
		@Test(priority = 11)
		public static void device5_Dual_AERO_I_Test() throws Exception
		{
		...
		@Test(priority = 12)
		public static void device5_Dual_AERO_II_Test() throws Exception
		{
		//	 AppiumDriver driver= Base.InitDriver(Resources.fetchResource("device5PortNo"), Resources.fetchResource("device5UdId"));
		...
		@Test(priority = 13)
		public static void device5_Dual_WA_Test() throws Exception
		{
		...
		@Test(priority = 14)
		public static void device5_Dual_YO_Test() throws Exception
		{
...
//Work whatsapp starts from here
		...
		@Test(priority = 15)
		public static void device5_Work_FM_Test() throws Exception
		{
		...
		@Test(priority = 16)
		public static void device5_Work_GB_Test() throws Exception
		{
		...
		@Test(priority = 17)
		public static void device5_Work_WB_Test() throws Exception
		{
		...
		@Test(priority = 18)
		public static void device5_Work_AERO_I_Test() throws Exception
		{
		...
		@Test(priority = 19)
		public static void device5_Work_AERO_II_Test() throws Exception
		{
		...
		@Test(priority = 20)
		public static void device5_Work_WA_Test() throws Exception
		{
		...
		@Test(priority = 21)
		public static void device5_Work_YO_Test() throws Exception
		{
